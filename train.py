...
from dataset import DataGenerator, DataGeneratorByPath
...
if __name__ == '__main__':
    ...
    #parser.add_argument('--character', type=str, default='가나다라마바사아자차카타파하')
    ...
    parser.add_argument('--data', type=str, default='./data/train_data.csv')
    
    opt = parser.parse_args()
    
    train(opt, data_type='All_data')