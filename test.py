...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_data', type=str, default='./data/test2')
    parser.add_argument('--batch_size', type=int, default=1)
    parser.add_argument('--saved_model', type=str, default='./saved_model/total_data/best_loss_0.04_model.h5')
